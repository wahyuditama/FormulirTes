      ...
      <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
        ...
        <ul class="menu-inner py-1">
          ...
          <li class="menu-item">
            ...
            <ul class="menu-sub">
              <li class="menu-item">
                <a href="content/tambah-gelombang.php" class="menu-link">
                  <div data-i18n="Account">Tambah Gelombang</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="content/tambah-jurusan.php" class="menu-link">
                  <div data-i18n="Connections">Tambah Jurusan</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="content/tambah-level.php" class="menu-link">
                  <div data-i18n="Notifications">Tambah Level</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="content/gelombang.php" class="menu-link">
                  <div data-i18n="Notifications">gelombang</div>
                </a>
              </li>
              <li class="menu-item">
                <a href="content/jurusan.php" class="menu-link">
